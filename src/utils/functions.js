...
export async function createList() {
    let
        { data: { response: covidSumData } } = await axios.get("https://covid-193.p.rapidapi.com/statistics", { headers: { "x-rapidapi-host": "covid-193.p.rapidapi.com", "x-rapidapi-key": "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" } }),
        { data: countriesData } = await axios.get("https://ajayakv-rest-countries-v1.p.rapidapi.com/rest/v1/all", { headers: { "x-rapidapi-host": "ajayakv-rest-countries-v1.p.rapidapi.com", "x-rapidapi-key": "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" } })
